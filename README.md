...
* [pymrio](https://github.com/konstantinstadler/pymrio) ⭐ 222 | 🐛 63 | 🌐 Python | 📅 2026-06-23 - Multi-Regional Input-Output Analysis in Python.
...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-08 - Open Source carbon accounting for cities.
...
* [Circular Economy Lifecycle Assessment and VIsualization (CELAVI) framework ](https://github.com/NREL/celavi) ⭐ 17 | 🐛 10 | 🌐 Python | 📅 2026-08-24 - Codebase for the Circular Economy Lifecycle Assessment and VIsualization (CELAVI) modeling framework.
...
* [premise](https://github.com/polca/premise) ⭐ 186 | 🐛 24 | 🌐 Python | 📅 2026-09-08 - PRospective EnvironMental Impact AsSEssment. Coupling the ecoinvent database with projections from Integrated Assessment Models (IAM).
...
* [nomenclature](https://github.com/IAMconsortium/nomenclature) ⭐ 24 | 🐛 53 | 🌐 Python | 📅 2026-08-25 - Working with IAMC-format project definitions.
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,457 | 🐛 115 | 🌐 Java | 📅 2026-09-07 - Apache Fineract: A Platform for Microfinance.
...
* [rafiki](https://github.com/interledger/rafiki) ⭐ 356 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-08 - An open-source, comprehensive Interledger service for wallet providers, enabling them to provide Interledger functionality to their users.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 152 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-08 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,973 | 🐛 103 | 🌐 Zig | 📅 2026-08-31 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [climate\_categories](https://github.com/pik-primap/climate_categories) ⭐ 17 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - Commonly used codes, categories, terminologies, and nomenclatures used in climate policy analysis in a nice Python package.
...
* [ETHOS.FINE](https://github.com/FZJ-IEK3-VSA/FINE) ⭐ 100 | 🐛 86 | 🌐 Python | 📅 2026-09-08 - Framework for Integrated Energy System Assessment
...
* [Awesome Fintech](https://github.com/moov-io/awesome-fintech) ⭐ 370 | 🐛 4 | 📅 2026-09-02 - A curated collection of open source fintech libraries and resources.
...
* [Awesome Europe](https://github.com/GeiserX/awesome-europe) ⭐ 130 | 🐛 4 | 🌐 Python | 📅 2026-09-08 - A curated list of open source software for Europe - institutions, regulations, standards, and cross-border infrastructure
