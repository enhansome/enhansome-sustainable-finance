...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-25 - Open Source carbon accounting for cities.
...
* [brightway-lca](https://github.com/brightway-lca/brightway2) ⭐ 139 | 🐛 24 | 🌐 Jupyter Notebook | 📅 2025-04-10 - Brightway2 is a framework for advanced life cycle assessment calculations.
...
* [premise](https://github.com/polca/premise) ⭐ 187 | 🐛 24 | 🌐 Python | 📅 2026-09-25 - PRospective EnvironMental Impact AsSEssment. Coupling the ecoinvent database with projections from Integrated Assessment Models (IAM).
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,510 | 🐛 134 | 🌐 Java | 📅 2026-09-25 - Apache Fineract: A Platform for Microfinance.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 152 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-25 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,084 | 🐛 116 | 🌐 Zig | 📅 2026-08-31 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [openGHG](https://github.com/openghg/openghg) ⭐ 46 | 🐛 269 | 🌐 Python | 📅 2026-09-25 - A cloud platform for greenhouse gas (GHG) data analysis and collaboration.
* [climate\_categories](https://github.com/pik-primap/climate_categories) ⭐ 17 | 🐛 6 | 🌐 Python | 📅 2026-09-25 - Commonly used codes, categories, terminologies, and nomenclatures used in climate policy analysis in a nice Python package.
...
* [electricityMap](https://github.com/electricitymap/electricitymap-contrib) ⭐ 4,033 | 🐛 127 | 🌐 Python | 📅 2026-09-25 - A real-time visualisation of the CO2 emissions of electricity consumption
  * [electricityMap Data Sources](https://github.com/electricitymap/electricitymap-contrib/blob/master/DATA_SOURCES.md) ⭐ 4,033 | 🐛 127 | 🌐 Python | 📅 2026-09-25
...
* [Awesome Fintech](https://github.com/moov-io/awesome-fintech) ⭐ 375 | 🐛 1 | 📅 2026-09-24 - A curated collection of open source fintech libraries and resources.
