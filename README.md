...
* [Equinox](https://github.com/open-risk/equinox) ⭐ 52 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-14 - Equinox is an open source platform that supports the holistic risk management of sustainable finance projects.
...
* [Scafandre](https://github.com/hubblo-org/scaphandre) ⭐ 1,974 | 🐛 101 | 🌐 Rust | 📅 2026-07-19 - Energy consumption metrology agent.
...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-21 - Open Source carbon accounting for cities.
...
* [MessageIX](https://github.com/iiasa/message_ix) ⭐ 150 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2026-09-18 - MESSAGEix is a versatile, dynamic, model framework for energy-engineering-economy-environment (E4) systems research.
...
* [mimi](https://github.com/mimiframework/Mimi.jl) ⭐ 72 | 🐛 69 | 🌐 Julia | 📅 2026-09-20 - Mimi is a Julia package that provides a component model for integrated assessment models.
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,502 | 🐛 128 | 🌐 Java | 📅 2026-09-21 - Apache Fineract: A Platform for Microfinance.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 152 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-21 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,058 | 🐛 112 | 🌐 Zig | 📅 2026-08-31 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [climate\_categories](https://github.com/pik-primap/climate_categories) ⭐ 17 | 🐛 6 | 🌐 Python | 📅 2026-09-14 - Commonly used codes, categories, terminologies, and nomenclatures used in climate policy analysis in a nice Python package.
...
* [electricityMap](https://github.com/electricitymap/electricitymap-contrib) ⭐ 4,034 | 🐛 125 | 🌐 Python | 📅 2026-09-21 - A real-time visualisation of the CO2 emissions of electricity consumption
  * [electricityMap Data Sources](https://github.com/electricitymap/electricitymap-contrib/blob/master/DATA_SOURCES.md) ⭐ 4,034 | 🐛 125 | 🌐 Python | 📅 2026-09-21
* [ETHOS.FINE](https://github.com/FZJ-IEK3-VSA/FINE) ⭐ 101 | 🐛 89 | 🌐 Python | 📅 2026-09-18 - Framework for Integrated Energy System Assessment
...
* [Open Sustainable Technology](https://github.com/protontypes/open-sustainable-technology#carbon-intensity-and-accounting) ⭐ 2,555 | 🐛 87 | 📅 2026-09-19 - A curated list of open technology projects to sustain a stable climate, energy supply, and natural resources
...
* [Industrial Ecology Dashboard](https://github.com/IndEcol/Dashboard) ⭐ 162 | 🐛 0 | 📅 2026-07-02 - A collection of open source projects relevant for industrial ecology practitioners, hosted on GitHub and beyond
