...
* [SBTi Temperature Alignment tool](https://github.com/ScienceBasedTargets/SBTi-finance-tool) ⭐ 63 | 🐛 18 | 🌐 Python | 📅 2026-07-30 - This toolkit helps companies and financial institutions to assess the temperature alignment of current targets, commitments, and investment and lending portfolios, and to use this information to develop targets for official validation by the SBTi.
* [Equinox](https://github.com/open-risk/equinox) ⭐ 52 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-10 - Equinox is an open source platform that supports the holistic risk management of sustainable finance projects.
...
* [climate-finance](https://github.com/ONEcampaign/climate-finance-package) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2026-08-11 - climate-finance is the python package to get, clean, and work with international public climate finance.
...
* [pymrio](https://github.com/konstantinstadler/pymrio) ⭐ 219 | 🐛 62 | 🌐 Python | 📅 2026-06-23 - Multi-Regional Input-Output Analysis in Python.
...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-12 - Open Source carbon accounting for cities.
...
* [MessageIX](https://github.com/iiasa/message_ix) ⭐ 149 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2026-08-11 - MESSAGEix is a versatile, dynamic, model framework for energy-engineering-economy-environment (E4) systems research.
...
* [nomenclature](https://github.com/IAMconsortium/nomenclature) ⭐ 24 | 🐛 48 | 🌐 Python | 📅 2026-08-04 - Working with IAMC-format project definitions.
...
* [rafiki](https://github.com/interledger/rafiki) ⭐ 354 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-12 - An open-source, comprehensive Interledger service for wallet providers, enabling them to provide Interledger functionality to their users.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 150 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-13 - An open-source browser extension that enables Web Monetization.
...
* [openGHG](https://github.com/openghg/openghg) ⭐ 46 | 🐛 252 | 🌐 Python | 📅 2026-08-10 - A cloud platform for greenhouse gas (GHG) data analysis and collaboration.
* [climate\_categories](https://github.com/pik-primap/climate_categories) ⭐ 17 | 🐛 8 | 🌐 Python | 📅 2026-08-10 - Commonly used codes, categories, terminologies, and nomenclatures used in climate policy analysis in a nice Python package.
...
* [Open Sustainable Technology](https://github.com/protontypes/open-sustainable-technology#carbon-intensity-and-accounting) ⭐ 2,540 | 🐛 76 | 📅 2026-08-01 - A curated list of open technology projects to sustain a stable climate, energy supply, and natural resources
...
* [Awesome Europe](https://github.com/GeiserX/awesome-europe) ⭐ 124 | 🐛 1 | 🌐 Python | 📅 2026-08-01 - A curated list of open source software for Europe - institutions, regulations, standards, and cross-border infrastructure
