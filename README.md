...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-12 - Open Source carbon accounting for cities.
...
* [premise](https://github.com/polca/premise) ⭐ 187 | 🐛 24 | 🌐 Python | 📅 2026-09-11 - PRospective EnvironMental Impact AsSEssment. Coupling the ecoinvent database with projections from Integrated Assessment Models (IAM).
...
* [openGHG](https://github.com/openghg/openghg) ⭐ 46 | 🐛 257 | 🌐 Python | 📅 2026-09-11 - A cloud platform for greenhouse gas (GHG) data analysis and collaboration.
...
* [electricityMap](https://github.com/electricitymap/electricitymap-contrib) ⭐ 4,034 | 🐛 125 | 🌐 Python | 📅 2026-09-11 - A real-time visualisation of the CO2 emissions of electricity consumption
  * [electricityMap Data Sources](https://github.com/electricitymap/electricitymap-contrib/blob/master/DATA_SOURCES.md) ⭐ 4,034 | 🐛 125 | 🌐 Python | 📅 2026-09-11
