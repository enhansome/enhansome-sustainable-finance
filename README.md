...
* [climate-finance](https://github.com/ONEcampaign/climate-finance-package) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - climate-finance is the python package to get, clean, and work with international public climate finance.
...
* [pymrio](https://github.com/konstantinstadler/pymrio) ⭐ 220 | 🐛 62 | 🌐 Python | 📅 2026-06-23 - Multi-Regional Input-Output Analysis in Python.
...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-14 - Open Source carbon accounting for cities.
...
* [nomenclature](https://github.com/IAMconsortium/nomenclature) ⭐ 24 | 🐛 49 | 🌐 Python | 📅 2026-08-04 - Working with IAMC-format project definitions.
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,375 | 🐛 86 | 🌐 Java | 📅 2026-08-13 - Apache Fineract: A Platform for Microfinance.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 150 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-14 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,785 | 🐛 122 | 🌐 Zig | 📅 2026-08-04 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [electricityMap](https://github.com/electricitymap/electricitymap-contrib) ⭐ 4,021 | 🐛 165 | 🌐 Python | 📅 2026-08-12 - A real-time visualisation of the CO2 emissions of electricity consumption
  * [electricityMap Data Sources](https://github.com/electricitymap/electricitymap-contrib/blob/master/DATA_SOURCES.md) ⭐ 4,021 | 🐛 165 | 🌐 Python | 📅 2026-08-12
...
* [Open Sustainable Technology](https://github.com/protontypes/open-sustainable-technology#carbon-intensity-and-accounting) ⭐ 2,541 | 🐛 76 | 📅 2026-08-01 - A curated list of open technology projects to sustain a stable climate, energy supply, and natural resources
...
* [Awesome Europe](https://github.com/GeiserX/awesome-europe) ⭐ 124 | 🐛 2 | 🌐 Python | 📅 2026-08-01 - A curated list of open source software for Europe - institutions, regulations, standards, and cross-border infrastructure
