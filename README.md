...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-20 - Open Source carbon accounting for cities.
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,393 | 🐛 99 | 🌐 Java | 📅 2026-08-19 - Apache Fineract: A Platform for Microfinance.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 150 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-21 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,856 | 🐛 125 | 🌐 Zig | 📅 2026-08-18 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [openGHG](https://github.com/openghg/openghg) ⭐ 46 | 🐛 252 | 🌐 Python | 📅 2026-08-20 - A cloud platform for greenhouse gas (GHG) data analysis and collaboration.
...
* [electricityMap](https://github.com/electricitymap/electricitymap-contrib) ⭐ 4,022 | 🐛 157 | 🌐 Python | 📅 2026-08-21 - A real-time visualisation of the CO2 emissions of electricity consumption
  * [electricityMap Data Sources](https://github.com/electricitymap/electricitymap-contrib/blob/master/DATA_SOURCES.md) ⭐ 4,022 | 🐛 157 | 🌐 Python | 📅 2026-08-21
* [ETHOS.FINE](https://github.com/FZJ-IEK3-VSA/FINE) ⭐ 100 | 🐛 87 | 🌐 Python | 📅 2026-08-20 - Framework for Integrated Energy System Assessment
