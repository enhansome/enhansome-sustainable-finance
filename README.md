...
* [Scafandre](https://github.com/hubblo-org/scaphandre) ⭐ 1,969 | 🐛 93 | 🌐 Rust | 📅 2026-07-19 - Energy consumption metrology agent.
...
* [openLCA](https://github.com/GreenDelta/olca-app) ⭐ 263 | 🐛 41 | 🌐 Java | 📅 2026-09-08 - Source code of openLCA
...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-09 - Open Source carbon accounting for cities.
...
* [brightway-lca](https://github.com/brightway-lca/brightway2) ⭐ 137 | 🐛 24 | 🌐 Jupyter Notebook | 📅 2025-04-10 - Brightway2 is a framework for advanced life cycle assessment calculations.
* [ODYM](https://github.com/IndEcol/ODYM) ⭐ 100 | 🐛 6 | 🌐 Python | 📅 2025-09-26 - Open Dynamic Material Systems Model.
* [PV ICE](https://github.com/NREL/PV_ICE) ⭐ 44 | 🐛 15 | 🌐 HTML | 📅 2026-08-24 - An open-source tool to quantify Solar Photovoltaics (PV) Energy and Mass Flows in the Circular Economy, from a Reliability and Lifetime approach.
...
* [Circular Economy Lifecycle Assessment and VIsualization (CELAVI) framework ](https://github.com/NREL/celavi) ⭐ 17 | 🐛 10 | 🌐 Python | 📅 2026-09-08 - Codebase for the Circular Economy Lifecycle Assessment and VIsualization (CELAVI) modeling framework.
...
* [premise](https://github.com/polca/premise) ⭐ 187 | 🐛 24 | 🌐 Python | 📅 2026-09-09 - PRospective EnvironMental Impact AsSEssment. Coupling the ecoinvent database with projections from Integrated Assessment Models (IAM).
* [MessageIX](https://github.com/iiasa/message_ix) ⭐ 150 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2026-09-09 - MESSAGEix is a versatile, dynamic, model framework for energy-engineering-economy-environment (E4) systems research.
...
* [mimi](https://github.com/mimiframework/Mimi.jl) ⭐ 72 | 🐛 68 | 🌐 Julia | 📅 2026-09-08 - Mimi is a Julia package that provides a component model for integrated assessment models.
...
* [nomenclature](https://github.com/IAMconsortium/nomenclature) ⭐ 24 | 🐛 54 | 🌐 Python | 📅 2026-08-25 - Working with IAMC-format project definitions.
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,467 | 🐛 119 | 🌐 Java | 📅 2026-09-09 - Apache Fineract: A Platform for Microfinance.
...
* [rafiki](https://github.com/interledger/rafiki) ⭐ 357 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-08 - An open-source, comprehensive Interledger service for wallet providers, enabling them to provide Interledger functionality to their users.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 152 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-09 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,980 | 🐛 103 | 🌐 Zig | 📅 2026-08-31 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [FaIR](https://github.com/OMS-NetZero/FAIR) ⭐ 160 | 🐛 31 | 🌐 Python | 📅 2026-08-27 - FaIR (the Finite-amplitude Impulse-Response) climate model is a simple climate model, or emulator, useful for producing global mean temperature projections from a wide range of emissions or prescribed forcing scenarios
* [openGHG](https://github.com/openghg/openghg) ⭐ 46 | 🐛 258 | 🌐 Python | 📅 2026-09-08 - A cloud platform for greenhouse gas (GHG) data analysis and collaboration.
* [climate\_categories](https://github.com/pik-primap/climate_categories) ⭐ 17 | 🐛 5 | 🌐 Python | 📅 2026-09-08 - Commonly used codes, categories, terminologies, and nomenclatures used in climate policy analysis in a nice Python package.
...
* [electricityMap](https://github.com/electricitymap/electricitymap-contrib) ⭐ 4,032 | 🐛 125 | 🌐 Python | 📅 2026-09-07 - A real-time visualisation of the CO2 emissions of electricity consumption
  * [electricityMap Data Sources](https://github.com/electricitymap/electricitymap-contrib/blob/master/DATA_SOURCES.md) ⭐ 4,032 | 🐛 125 | 🌐 Python | 📅 2026-09-07
* [ETHOS.FINE](https://github.com/FZJ-IEK3-VSA/FINE) ⭐ 100 | 🐛 81 | 🌐 Python | 📅 2026-09-09 - Framework for Integrated Energy System Assessment
...
* [Open Sustainable Technology](https://github.com/protontypes/open-sustainable-technology#carbon-intensity-and-accounting) ⭐ 2,547 | 🐛 79 | 📅 2026-09-08 - A curated list of open technology projects to sustain a stable climate, energy supply, and natural resources
...
* [Awesome Europe](https://github.com/GeiserX/awesome-europe) ⭐ 130 | 🐛 3 | 🌐 Python | 📅 2026-09-08 - A curated list of open source software for Europe - institutions, regulations, standards, and cross-border infrastructure
