...
* [Equinox](https://github.com/open-risk/equinox) ⭐ 52 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-21 - Equinox is an open source platform that supports the holistic risk management of sustainable finance projects.
...
* [Scafandre](https://github.com/hubblo-org/scaphandre) ⭐ 1,975 | 🐛 101 | 🌐 Rust | 📅 2026-07-19 - Energy consumption metrology agent.
...
* [openLCA](https://github.com/GreenDelta/olca-app) ⭐ 264 | 🐛 41 | 🌐 Java | 📅 2026-09-19 - Source code of openLCA
...
* [MARIO](https://github.com/it-is-me-mario/MARIO) ⭐ 52 | 🐛 22 | 🌐 Python | 📅 2026-09-18 - Multifunctional Analysis of Regions through Input-Output
...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-22 - Open Source carbon accounting for cities.
...
* [brightway-lca](https://github.com/brightway-lca/brightway2) ⭐ 138 | 🐛 24 | 🌐 Jupyter Notebook | 📅 2025-04-10 - Brightway2 is a framework for advanced life cycle assessment calculations.
* [ODYM](https://github.com/IndEcol/ODYM) ⭐ 101 | 🐛 6 | 🌐 Python | 📅 2025-09-26 - Open Dynamic Material Systems Model.
...
* [Circular Economy Lifecycle Assessment and VIsualization (CELAVI) framework ](https://github.com/NREL/celavi) ⭐ 17 | 🐛 7 | 🌐 Python | 📅 2026-09-15 - Codebase for the Circular Economy Lifecycle Assessment and VIsualization (CELAVI) modeling framework.
...
* [pyam](https://github.com/IAMconsortium/pyam) ⭐ 289 | 🐛 105 | 🌐 Python | 📅 2026-09-08 - Analysis & visualization of integrated-assessment and macro-energy scenarios.
* [premise](https://github.com/polca/premise) ⭐ 187 | 🐛 24 | 🌐 Python | 📅 2026-09-19 - PRospective EnvironMental Impact AsSEssment. Coupling the ecoinvent database with projections from Integrated Assessment Models (IAM).
* [MessageIX](https://github.com/iiasa/message_ix) ⭐ 150 | 🐛 144 | 🌐 Jupyter Notebook | 📅 2026-09-18 - MESSAGEix is a versatile, dynamic, model framework for energy-engineering-economy-environment (E4) systems research.
...
* [mimi](https://github.com/mimiframework/Mimi.jl) ⭐ 72 | 🐛 75 | 🌐 Julia | 📅 2026-09-22 - Mimi is a Julia package that provides a component model for integrated assessment models.
...
* [python-DICE](https://github.com/Shivamshaiv/Python-DICE) ⭐ 24 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2020-07-17 - Python 3.6 implementation of Dynamic Integrated Climate-Economy (DICE).
* [nomenclature](https://github.com/IAMconsortium/nomenclature) ⭐ 24 | 🐛 56 | 🌐 Python | 📅 2026-09-16 - Working with IAMC-format project definitions.
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,502 | 🐛 130 | 🌐 Java | 📅 2026-09-21 - Apache Fineract: A Platform for Microfinance.
...
* [rafiki](https://github.com/interledger/rafiki) ⭐ 359 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-21 - An open-source, comprehensive Interledger service for wallet providers, enabling them to provide Interledger functionality to their users.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 152 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-22 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,070 | 🐛 114 | 🌐 Zig | 📅 2026-08-31 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [openGHG](https://github.com/openghg/openghg) ⭐ 46 | 🐛 265 | 🌐 Python | 📅 2026-09-21 - A cloud platform for greenhouse gas (GHG) data analysis and collaboration.
* [climate\_categories](https://github.com/pik-primap/climate_categories) ⭐ 17 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - Commonly used codes, categories, terminologies, and nomenclatures used in climate policy analysis in a nice Python package.
...
* [electricityMap](https://github.com/electricitymap/electricitymap-contrib) ⭐ 4,033 | 🐛 123 | 🌐 Python | 📅 2026-09-21 - A real-time visualisation of the CO2 emissions of electricity consumption
  * [electricityMap Data Sources](https://github.com/electricitymap/electricitymap-contrib/blob/master/DATA_SOURCES.md) ⭐ 4,033 | 🐛 123 | 🌐 Python | 📅 2026-09-21
* [ETHOS.FINE](https://github.com/FZJ-IEK3-VSA/FINE) ⭐ 101 | 🐛 89 | 🌐 Python | 📅 2026-09-21 - Framework for Integrated Energy System Assessment
...
* [SDG Data Repository (UK)](https://github.com/ONSdigital/sdg-data) ⭐ 20 | 🐛 5 | 🌐 Python | 📅 2026-08-24 - Data repository for SDGs

# Broader and/or Related Domains

Other awesome lists / resources that are more indirectly relevant for sustainable finance

* [Open Sustainable Technology](https://github.com/protontypes/open-sustainable-technology#carbon-intensity-and-accounting) ⭐ 2,555 | 🐛 85 | 📅 2026-09-21 - A curated list of open technology projects to sustain a stable climate, energy supply, and natural resources
...
* [Industrial Ecology Dashboard](https://github.com/IndEcol/Dashboard) ⭐ 168 | 🐛 0 | 📅 2026-07-02 - A collection of open source projects relevant for industrial ecology practitioners, hosted on GitHub and beyond
* [Awesome Europe](https://github.com/GeiserX/awesome-europe) ⭐ 132 | 🐛 3 | 🌐 Python | 📅 2026-09-08 - A curated list of open source software for Europe - institutions, regulations, standards, and cross-border infrastructure
