...
* [Equinox](https://github.com/open-risk/equinox) ⭐ 52 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-24 - Equinox is an open source platform that supports the holistic risk management of sustainable finance projects.
...
* [openLCA](https://github.com/GreenDelta/olca-app) ⭐ 263 | 🐛 40 | 🌐 Java | 📅 2026-08-25 - Source code of openLCA
...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-26 - Open Source carbon accounting for cities.
...
* [premise](https://github.com/polca/premise) ⭐ 184 | 🐛 24 | 🌐 Python | 📅 2026-08-23 - PRospective EnvironMental Impact AsSEssment. Coupling the ecoinvent database with projections from Integrated Assessment Models (IAM).
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,402 | 🐛 104 | 🌐 Java | 📅 2026-08-25 - Apache Fineract: A Platform for Microfinance.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 150 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-26 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,906 | 🐛 110 | 🌐 Zig | 📅 2026-08-25 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [electricityMap](https://github.com/electricitymap/electricitymap-contrib) ⭐ 4,024 | 🐛 125 | 🌐 Python | 📅 2026-08-26 - A real-time visualisation of the CO2 emissions of electricity consumption
  * [electricityMap Data Sources](https://github.com/electricitymap/electricitymap-contrib/blob/master/DATA_SOURCES.md) ⭐ 4,024 | 🐛 125 | 🌐 Python | 📅 2026-08-26
...
* [Open Sustainable Technology](https://github.com/protontypes/open-sustainable-technology#carbon-intensity-and-accounting) ⭐ 2,544 | 🐛 77 | 📅 2026-08-23 - A curated list of open technology projects to sustain a stable climate, energy supply, and natural resources
