...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-14 - Open Source carbon accounting for cities.
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,476 | 🐛 114 | 🌐 Java | 📅 2026-09-14 - Apache Fineract: A Platform for Microfinance.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 152 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-14 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,014 | 🐛 107 | 🌐 Zig | 📅 2026-08-31 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [openGHG](https://github.com/openghg/openghg) ⭐ 46 | 🐛 257 | 🌐 Python | 📅 2026-09-14 - A cloud platform for greenhouse gas (GHG) data analysis and collaboration.
...
* [electricityMap](https://github.com/electricitymap/electricitymap-contrib) ⭐ 4,034 | 🐛 125 | 🌐 Python | 📅 2026-09-14 - A real-time visualisation of the CO2 emissions of electricity consumption
  * [electricityMap Data Sources](https://github.com/electricitymap/electricitymap-contrib/blob/master/DATA_SOURCES.md) ⭐ 4,034 | 🐛 125 | 🌐 Python | 📅 2026-09-14
* [ETHOS.FINE](https://github.com/FZJ-IEK3-VSA/FINE) ⭐ 100 | 🐛 79 | 🌐 Python | 📅 2026-09-14 - Framework for Integrated Energy System Assessment
...
* [Open Sustainable Technology](https://github.com/protontypes/open-sustainable-technology#carbon-intensity-and-accounting) ⭐ 2,549 | 🐛 78 | 📅 2026-09-09 - A curated list of open technology projects to sustain a stable climate, energy supply, and natural resources
