...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-03 - Open Source carbon accounting for cities.
...
* [nomenclature](https://github.com/IAMconsortium/nomenclature) ⭐ 24 | 🐛 51 | 🌐 Python | 📅 2026-08-25 - Working with IAMC-format project definitions.
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,425 | 🐛 108 | 🌐 Java | 📅 2026-09-02 - Apache Fineract: A Platform for Microfinance.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 150 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-03 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,949 | 🐛 102 | 🌐 Zig | 📅 2026-08-31 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [openGHG](https://github.com/openghg/openghg) ⭐ 46 | 🐛 256 | 🌐 Python | 📅 2026-09-03 - A cloud platform for greenhouse gas (GHG) data analysis and collaboration.
...
* [ETHOS.FINE](https://github.com/FZJ-IEK3-VSA/FINE) ⭐ 100 | 🐛 88 | 🌐 Python | 📅 2026-09-03 - Framework for Integrated Energy System Assessment
