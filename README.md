...
* [Scafandre](https://github.com/hubblo-org/scaphandre) ⭐ 1,972 | 🐛 97 | 🌐 Rust | 📅 2026-07-19 - Energy consumption metrology agent.
...
* [openLCA](https://github.com/GreenDelta/olca-app) ⭐ 264 | 🐛 41 | 🌐 Java | 📅 2026-09-14 - Source code of openLCA
...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-15 - Open Source carbon accounting for cities.
...
* [Circular Economy Lifecycle Assessment and VIsualization (CELAVI) framework ](https://github.com/NREL/celavi) ⭐ 17 | 🐛 9 | 🌐 Python | 📅 2026-09-14 - Codebase for the Circular Economy Lifecycle Assessment and VIsualization (CELAVI) modeling framework.
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,477 | 🐛 107 | 🌐 Java | 📅 2026-09-15 - Apache Fineract: A Platform for Microfinance.
...
* [rafiki](https://github.com/interledger/rafiki) ⭐ 358 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-14 - An open-source, comprehensive Interledger service for wallet providers, enabling them to provide Interledger functionality to their users.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 152 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-15 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,018 | 🐛 106 | 🌐 Zig | 📅 2026-08-31 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [openGHG](https://github.com/openghg/openghg) ⭐ 46 | 🐛 258 | 🌐 Python | 📅 2026-09-14 - A cloud platform for greenhouse gas (GHG) data analysis and collaboration.
...
* [ETHOS.FINE](https://github.com/FZJ-IEK3-VSA/FINE) ⭐ 100 | 🐛 81 | 🌐 Python | 📅 2026-09-14 - Framework for Integrated Energy System Assessment
...
* [Open Sustainable Technology](https://github.com/protontypes/open-sustainable-technology#carbon-intensity-and-accounting) ⭐ 2,551 | 🐛 78 | 📅 2026-09-09 - A curated list of open technology projects to sustain a stable climate, energy supply, and natural resources
