...
* [Equinox](https://github.com/open-risk/equinox) ⭐ 52 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-31 - Equinox is an open source platform that supports the holistic risk management of sustainable finance projects.
...
* [CityCatalyst](https://github.com/Open-Earth-Foundation/CityCatalyst) ⭐ 45 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-31 - Open Source carbon accounting for cities.
...
* [MessageIX](https://github.com/iiasa/message_ix) ⭐ 150 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2026-08-30 - MESSAGEix is a versatile, dynamic, model framework for energy-engineering-economy-environment (E4) systems research.
...
* [nomenclature](https://github.com/IAMconsortium/nomenclature) ⭐ 24 | 🐛 50 | 🌐 Python | 📅 2026-08-25 - Working with IAMC-format project definitions.
...
* [Fineract](https://github.com/apache/fineract/) ⭐ 2,417 | 🐛 107 | 🌐 Java | 📅 2026-08-31 - Apache Fineract: A Platform for Microfinance.
...
* [web-monetization](https://github.com/interledger/web-monetization-extension) ⭐ 150 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-31 - An open-source browser extension that enables Web Monetization.

#### Other

* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,934 | 🐛 103 | 🌐 Zig | 📅 2026-08-31 - The distributed financial transactions database designed for mission critical safety and performance.
...
* [electricityMap](https://github.com/electricitymap/electricitymap-contrib) ⭐ 4,029 | 🐛 125 | 🌐 Python | 📅 2026-08-31 - A real-time visualisation of the CO2 emissions of electricity consumption
  * [electricityMap Data Sources](https://github.com/electricitymap/electricitymap-contrib/blob/master/DATA_SOURCES.md) ⭐ 4,029 | 🐛 125 | 🌐 Python | 📅 2026-08-31
